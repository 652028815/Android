 ...
 * Date：  2018/5/30.
 */
class NewsPageKeyedDataSource(val category: String) :
    ...
    override fun loadInitial(params: LoadInitialParams<Response<NewsResponse>>,
                             callback: LoadInitialCallback<Response<NewsResponse>, News>) {
        Api.getAllNews(category, "15", null)
    ...
    override fun loadAfter(params: LoadParams<Response<NewsResponse>>,
                           callback: LoadCallback<Response<NewsResponse>, News>) {
        Api.getAllNews(category, "15", params.key.data.last_id)
    ...
    override fun loadBefore(params: LoadParams<Response<NewsResponse>>,
                            callback: LoadCallback<Response<NewsResponse>, News>) {
